...
const Landing = () => (
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-7 col-xs-4 content-wrapper result-header">
                  <a href="index.html"><img className="logo" src="images/black-logo.png" alt="Findious" /></a>
                  <SearchBar />
                </div>
  ...
  <section id="about" className="about-section clearfix">
    <div className="col-sm-6 user-video-wrapper hidden-xs" style={{ backgroundImage: 'url(images/video-back.jpg)' }}>
      <button className="play-btn" id="trigger-overlay" ><i className="fa fa-play"></i></button>
      <div className="overlay style overlay-hugeinc" data-video="VqCjpIADs4Y">
        <button type="button" className="video-container--close"></button>
      </div>
    </div>
    <div className="col-sm-6 page-navigation">
      <button className="btn close-btn overlay-close"></button>
      <h1>Alexander<br/>
        cafe</h1>
    ...
    <div className="col-sm-6 user-video-wrapper visible-xs" style={{ backgroundImage: ' url(images/video-back.jpg)' }}>
      <button className="play-btn" id="trigger-overlay-mobile" ><i className="fa fa-play"></i></button>
  ...
  <section id="testimonials" className="review-section"> <i className="fa fa-quote-right" aria-hidden="true"></i>
