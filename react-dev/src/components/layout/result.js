    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-xs-7 col-md-4 text-right">
          <button className="plus-btn"><i className="fa fa-plus"></i></button>
          <Weather />
        </div>
    </div>
    </div>
      ...
      <div className="col-md-1 filter-wrapper">
        <div className="filter">
          ...
          <ul className="clearfix">
            <li> <a href="#"><i className="fa fa-play-circle-o" aria-hidden="true"></i>videos</a> <span className="selected"><i className="fa fa-check"></i></span> </li>
            <li> <a href="#"><i className="fa fa-volume-up" aria-hidden="true"></i>audios</a> </li>
            <li> <a href="#"><i className="fa fa-camera" aria-hidden="true"></i>images</a> </li>
            <li> <a href="#"><i className="fa fa-map-marker" aria-hidden="true"></i>mav view</a> </li>
            <li> <a href="#"><i className="fa fa-expand" aria-hidden="true"></i>furtherest</a> </li>
            <li> <a href="#"><i className="fa fa-compress" aria-hidden="true"></i>nearest</a> </li>
            <li> <a href="#"><i className="fa fa-line-chart" aria-hidden="true"></i>popular</a> </li>
          </ul>
        </div>
      </div>
